...
форм (**square**, **triangle**, **circle**, **polygon**) и флажком **Filled** для
включения заливки. Для роли **sprite** отображается категория
**Sprite**, где можно указать путь к изображению и отключить
фильтрацию с помощью флажка **Smooth**.

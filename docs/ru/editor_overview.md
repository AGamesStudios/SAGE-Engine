...
яркая рамка с узлами для перемещения и изменения размера; зажав **Shift**, можно сохранить пропорции. В меню *View* доступны переключатели **Mirror Resize** и **Show Bounding Box**. Если скрыть рамку, узлы останутся видимы, поэтому работать можно и без неё.
Горячие клавиши

...
class ViewSettingsPopup(QFrame):
    ...
    def __init__(self, editor: "Editor"):
        ...
        self.grid_chk.setToolTip(editor.t('show_grid_hint'))
        ...
        self.snap_chk.setToolTip(editor.t('snap_steps_hint'))
        self.snap_chk.setChecked(editor.snap_steps)
        layout.addWidget(self.snap_chk)

        move_row = QHBoxLayout()
        move_label = QLabel(editor.t('move_step'))
        move_label.setToolTip(editor.t('move_step_hint'))
        ...
        self.move_spin.setToolTip(editor.t('move_step_hint'))
        move_row.addWidget(self.move_spin)
        layout.addLayout(move_row)

        rot_row = QHBoxLayout()
        rot_label = QLabel(editor.t('rotate_step'))
        rot_label.setToolTip(editor.t('rotate_step_hint'))
        ...
        self.rot_spin.setToolTip(editor.t('rotate_step_hint'))
        rot_row.addWidget(self.rot_spin)
        layout.addLayout(rot_row)

        scale_row = QHBoxLayout()
        scale_label = QLabel(editor.t('scale_step'))
        scale_label.setToolTip(editor.t('scale_step_hint'))
        scale_row.addWidget(scale_label)
        self.scale_spin = QDoubleSpinBox()
        self.scale_spin.setRange(0.01, 10.0)
        self.scale_spin.setDecimals(3)
        self.scale_spin.setValue(editor.scale_step)
        self.scale_spin.setToolTip(editor.t('scale_step_hint'))
        scale_row.addWidget(self.scale_spin)
        layout.addLayout(scale_row)

        self.color_btn = QPushButton(editor.t('grid_color'))
        self.color_btn.setToolTip(editor.t('grid_color_hint'))
...
class Editor(QMainWindow):
    ...
    def _apply_language(self):
        ...
        if hasattr(self, 'view_opts_popup'):
            ...
            self.view_opts_popup.grid_chk.setToolTip(self.t('show_grid_hint'))
            self.view_opts_popup.gizmo_chk.setText(self.t('show_gizmo'))
            self.view_opts_popup.snap_chk.setText(self.t('snap_steps'))
            self.view_opts_popup.snap_chk.setToolTip(self.t('snap_steps_hint'))
            ...
            self.view_opts_popup.move_spin.setToolTip(self.t('move_step_hint'))
            ...
            self.view_opts_popup.rot_spin.setToolTip(self.t('rotate_step_hint'))
            ...
            self.view_opts_popup.scale_spin.setToolTip(self.t('scale_step_hint'))
            self.view_opts_popup.color_btn.setText(self.t('grid_color'))
            self.view_opts_popup.color_btn.setToolTip(self.t('grid_color_hint'))
    ...
    def run_project(self):
        ...
        try:
            ...
            window = engine.run()
            window.closed.connect(self._on_game_closed)

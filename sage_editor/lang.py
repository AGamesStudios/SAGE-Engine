LANGUAGES = {
    'English': {
        ...
        'viewport': 'Viewport',
        'logic': 'Logic',
        'scene_logic': 'Scene Logic',
        'object_logic': 'Object Logic',
        'variables': 'Variables',
        'name': 'Name',
        'value': 'Value',
        'add_event': 'Add Event',
        ...
        'project_launcher': 'SAGE Project (Experimental)',
        'project_list': 'Project List',
        'no_recent_projects': 'No projects found',
        'created': 'Created',
        'last_run': 'Last Run',
        'path': 'Path',
        'current': 'Current',
        ...
        , 'show_grid': 'Show Grid'
        , 'show_grid_hint': 'Displays a measurement grid.\nSnapping is unaffected.'
        , 'snap_steps': 'Snap to Steps'
        , 'snap_steps_hint': 'Objects move, rotate and scale in the steps set below.'
        , 'move_step': 'Move Step:'
        , 'move_step_hint': 'Distance objects move when snap is enabled.'
        , 'rotate_step': 'Rotate Step:'
        , 'rotate_step_hint': 'Angle objects rotate when snap is enabled.'
        , 'scale_step': 'Scale Step:'
        , 'scale_step_hint': 'Scale amount when snap is enabled.'
        , 'grid_size': 'Grid Size:'
        , 'grid_size_hint': 'Distance between grid lines in meters.'
        , 'grid_color': 'Grid Color'
        , 'grid_color_hint': 'Choose the color of the grid lines.'
        , 'font_size': 'Font Size'
        , 'theme': 'Theme'
        , 'dark_theme': 'Dark'
        , 'light_theme': 'Light'
    ...
    'Русский': {
        ...
        'viewport': 'Сцена',
        'logic': 'Логика',
        'scene_logic': 'Логика сцены',
        'object_logic': 'Логика объекта',
        ...
        'project_launcher': 'SAGE Project (Экспериментально)',
        'project_list': 'Список проектов',
        'no_recent_projects': 'Проекты не найдены',
        'created': 'Создан',
        ...
        , 'restart_editor': 'Перезапустить редактор'
        , 'exit': 'Выход'
        ...
        , 'show_grid_hint': 'Отображает измерительную сетку.\nНа привязку не влияет.'
        , 'snap_steps': 'Привязка по шагу'
        , 'snap_steps_hint': 'Перемещение, вращение и масштаб идут с указанным шагом.'
        , 'move_step': 'Шаг перемещения:'
        , 'move_step_hint': 'Расстояние перемещения при включённой привязке.'
        , 'rotate_step': 'Шаг поворота:'
        , 'rotate_step_hint': 'Угол поворота при включённой привязке.'
        , 'scale_step': 'Шаг масштабирования:'
        , 'scale_step_hint': 'Изменение масштаба при включённой привязке.'
        , 'grid_size': 'Шаг сетки:'
        , 'grid_size_hint': 'Расстояние между линиями сетки в метрах.'
        , 'grid_color': 'Цвет сетки'
        , 'grid_color_hint': 'Выбор цвета линий сетки.'
        , 'font_size': 'Размер шрифта'
        , 'theme': 'Тема'
        , 'dark_theme': 'Тёмная'
        , 'light_theme': 'Светлая'

        , 'show_gizmo': 'Показывать гизмо'
